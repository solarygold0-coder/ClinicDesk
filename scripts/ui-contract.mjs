...
const checks = [
  ...
  ['patient display explicitly uses Gregorian calendar', files.patients.includes('ar-SA-u-ca-gregory') || (files.patients.includes("from './dateDisplay'") && files.dateDisplay.includes('ar-SA-u-ca-gregory'))],
  ['appointment display explicitly uses Gregorian calendar', files.appointments.includes('ar-SA-u-ca-gregory') || (files.appointments.includes("from './dateDisplay'") && files.dateDisplay.includes('ar-SA-u-ca-gregory'))],
  ['dashboard display explicitly uses Gregorian calendar', files.dashboard.includes('ar-SA-u-ca-gregory') || (files.dashboard.includes("from './dateDisplay'") && files.dateDisplay.includes('ar-SA-u-ca-gregory'))],
  ['settings display explicitly uses Gregorian calendar', files.scheduling.includes('ar-SA-u-ca-gregory') || (files.scheduling.includes("from './dateDisplay'") && files.dateDisplay.includes('ar-SA-u-ca-gregory'))],
