...
const checks = [
  ...
  ['attachment open verifies integrity before Windows association', runtime.includes('backup::sha256_file(&path)?') && runtime.includes('app.opener()') && runtime.includes('open_path(path, None::<&str>)')],
